            ...
            {staff.length === 0 ? (
              ...
              <div className="divide-y divide-gray-200">
                {staff.map((u, i) => (
                  <div
                    key={i}
                    className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 p-4 sm:p-6 hover:bg-gray-50 transition-colors"
                  >
                    <div className="flex items-center space-x-3 sm:space-x-4 min-w-0">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 rounded-full bg-gradient-to-r from-purple-400 to-purple-600 flex items-center justify-center text-white font-bold text-base sm:text-lg">
                    ...
                    <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                      ...
                      <button
                        ...
                        className="flex-1 sm:flex-none bg-blue-50 text-blue-600 px-3 sm:px-4 py-2 rounded-lg hover:bg-blue-100 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 sm:flex-none bg-red-50 text-red-600 px-3 sm:px-4 py-2 rounded-lg hover:bg-red-100 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                      >
                        {deletingId === u.Email ? (
                          <>
            ...
            {couples.length === 0 ? (
              ...
              <div className="divide-y divide-gray-200">
                {couples.map((u, i) => (
                  ...
                  >
                    <div className="flex items-center space-x-3 sm:space-x-4 min-w-0">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold text-base sm:text-lg">
                    ...
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        disabled={resettingEmail === u.Email}
                        className="w-full sm:w-auto bg-orange-50 text-orange-600 px-3 sm:px-4 py-2 rounded-lg hover:bg-orange-100 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                      >
                        {resettingEmail === u.Email ? (
                          <>
