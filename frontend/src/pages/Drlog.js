...
function Drlog() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setError(t("drlog.error_invalid") || "Invalid credentials. Please try again.");
    }
  };

  return (
    <div className="dr-font-body" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#fcfcfc" }}>
      <style>{injectStyles}</style>

      <div style={{ flex: 1, display: "flex" }}>
        {/* Left Side Visual Banner */}
        <div className="dr-left-banner" style={{
          width: "48%", position: "relative", background: "#111827",
          ...
          <div style={{ position: "relative", zIndex: 10, padding: "0 64px", textAlign: "center", maxWidth: 460 }}>
            {/* Status Pill Badge */}
            <div style={{
              display: "inline-flex", alignItems: "center", gap: 10,
              background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)",
              color: "#fca5a5", fontSize: 10, fontWeight: 600, letterSpacing: "0.2em",
              textTransform: "uppercase", padding: "6px 18px", borderRadius: 999, marginBottom: 32
            }}>
              <span className="dr-animate-pulse" style={{ width: 6, height: 6, borderRadius: "50%", background: "#ef4444", display: "inline-block" }} />
              {t("login.left.pill")}
            </div>

            <h2 className="dr-font-display" style={{ fontSize: 46, fontWeight: 700, color: "#fff", lineHeight: 1.15, marginBottom: 20 }}>
              {t("login.left.title1")}
              <br />
              <em style={{ fontStyle: "normal", color: "#fca5a5" }}>{t("login.left.title2")}</em>
            </h2>

            <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 14, fontWeight: 300, lineHeight: 1.75 }}>
          ...
          <div style={{ position: "absolute", bottom: 40, left: 0, right: 0, textAlign: "center" }}>
            <p style={{ color: "rgba(255,255,255,0.25)", fontSize: 11, fontStyle: "italic", fontWeight: 300 }}>
              {t("login.left.quote")}
            </p>
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 32px" }}>
          ...
          <div className="dr-mobile-badge-container" style={{ marginBottom: 36, textAlign: "center" }}>
            <div style={{
              display: "inline-flex", alignItems: "center", gap: 8, background: "#111827",
              color: "#fecaca", fontSize: 10, fontWeight: 600, letterSpacing: "0.18em",
          ...
          <div style={{ width: "100%", maxWidth: 360 }}>
            ...
            <div className="dr-fade-up dr-fade-up-1" style={{ marginBottom: 32 }}>
              <h1 className="dr-font-display" style={{ fontSize: 38, fontWeight: 700, color: "#111827", lineHeight: 1.2, marginBottom: 8 }}>
                {t("drlog.title")}
              </h1>
              <p style={{ color: "#6b7280", fontSize: 14, fontWeight: 300, lineHeight: 1.6 }}>
                {t("drlog.subtitle")}
              </p>
            </div>

            {/* Micro Separation Rule */}
            <div className="dr-fade-up dr-fade-up-2" style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
              <div className="dr-divider-line" />
              <span style={{ fontSize: 10, color: "#9ca3af", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 500, whiteSpace: "nowrap" }}>
            ...
            <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {error && (
                <div className="dr-fade-up" style={{ padding: "12px", background: "#fef2f2", border: "1px solid #fee2e2", borderRadius: "8px", color: "#991b1b", fontSize: "13px", fontWeight: 400 }}>
                  {error}
                </div>
              )}

              <div className="dr-fade-up dr-fade-up-2">
                <label style={{ display: "block", fontSize: 11, fontWeight: 600, color: "#4b5563", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>
                  {t("drlog.email_label")}
                </label>
              ...
              <div className="dr-fade-up dr-fade-up-3" style={{ display: "flex", justifyContent: "flex-end", marginTop: "-4px" }}>
                <a
